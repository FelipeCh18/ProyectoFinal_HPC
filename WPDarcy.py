...
with Timer() as t:
    ...
    mesh= RectangleMesh(comm,Point(x0,y0),Point(x1,y1),l,h,'right')
    ...
    if(rank==0):
        t.stop()
    print("Wall time: ", t.elapsed()[1],"User time: ",t.elapsed()[2], "id del proceso ",rank)

    #Visualización
    file = XDMFFile("PDarcy.xdmf")
    file.write(u)
    #Visualizción gradiente
    #file= XDMFFile("GDarcy.xdmf")
    #file.write(alfa)
